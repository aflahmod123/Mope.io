...
You got firestream that burns your victim alive! Watch your tail and slap them hard.";
    ...
    case a_lochness:
      ...
      infoO.aniDesc = "";
      infoO.upgradeText =
        "UPGRADED to " + infoO.aniName + "upgrade To Demon Fish!";
    ...
    case a_mole:
      infoO.aniName = "Mole";
      infoO.aniDesc = "";
      infoO.upgradeText = "UPGRADED to White Rhino!!";
      infoO.aniCol = "#4C4A45";
      infoO.skinName = "mole";
      break;
    case a_zebra:
    ...
    case a_bigCat:
      ...
      infoO.aniDesc = "";
      infoO.upgradeText = "UPGRADED to Pakistan Vulture!!!";
      infoO.aniCol = "#CAC05B";
    ...
    case a_falcon:
      ...
      infoO.aniCol = "#FF9000";
      infoO.skinName = "skins/falcon/0/falcon";
...
You got firestream that burns your victim alive! Watch your tail and slap them hard.";
    ...
    case a_lochness:
      ...
      infoO.upgradeText =
        "UPGRADED to " +
        "demon fish know how to walk and breathe! / they don't need water!";
    ...
    case a_griffin:
      infoO.aniName = "";
      infoO.aniDesc = "";
      infoO.upgradeText = "UPGRADED to " + infoO.aniName + "Jackass";
    ...
    case a_mole:
      infoO.aniName = "Mole";
      infoO.aniDesc = "";
      infoO.upgradeText = "UPGRADED to Rare Black Rhino!";
      infoO.aniCol = "#4C4A45";
      infoO.skinName = "mole";
      break;
    case a_zebra:
    ...
    case a_pelican:
      ...
      break;
    case a_falcon:
      infoO.aniName = "Pakistan Macaw";
      infoO.aniDesc = "";
      infoO.upgradeText = "UPGRADED to Pakistan Macaw!";
      infoO.aniCol = "#FF9000";
      infoO.skinName = "skins/falcon/0/falcon";
    ...
    case a_dinoMonster:
      infoO.aniName = "Dino Monster";
      infoO.upgradeText =
        "UPGRADED to Dino Monster these OP pushes everyone to the end of the map!";
      infoO.aniCol = "#FF9000";
      infoO.skinName = "monsters/dinomonster/dinomonster3";
      break;
    case a_pigeon:
